...
const BlogCard = ({ blog, loading = false, showActions = true }: BlogCardProps) => {
    ...
    return (
        <div key={blog._id} className="shadow container mx-auto px-2 bg-[#FFFFFF] py-3 rounded-md">

            <div className="flex lg:w-90 flex-col space-y-4">
                <Link to={`/blog-detail/${blog?._id}/${blog?.slug}`}>
